...
const PANELS: PanelDef[] = [
  {
    ...
    rules: [
      ...
      rangeRule(/^wbc$/i, "WBC (white cell count)", "x10⁹/L", 4.0, 10.0),
      rangeRule(/^neutrophils?$/i, "Neutrophils", "x10⁹/L", 2.0, 7.0),
      rangeRule(/^lymphocytes?$/i, "Lymphocytes", "x10⁹/L", 1.0, 4.0),
      rangeRule(/^monocytes?$/i, "Monocytes", "x10⁹/L", 0.2, 1.0),
      rangeRule(/^eosinophils?$/i, "Eosinophils", "x10⁹/L", 0.02, 0.5),
      rangeRule(/^basophils?$/i, "Basophils", "x10⁹/L", 0.0, 0.1),
      rangeRule(/^platelets?$/i, "Platelets", "x10⁹/L", 150, 410),
